...
@dataclass(frozen=True)
class IncrementalInputTemplate(ReducedInputTemplate):
    ...
    def instantiate(
        ...
        return OrderedCellGraphInput(
            ...
            predecessor_orders=self.predecessor_orders,
            predecessor_max_order=self.predecessor_max_order,
            has_circular_predecessor=self.has_circular_predecessor,
            circle_len=(
