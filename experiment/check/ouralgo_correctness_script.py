...
from experiment.check.backup_fo2_to_cnf_converter import fo2_to_cnf_count
import experiment.check.backup_fo2_to_cnf_converter as backup_fo2_to_cnf_converter
import pandas as pd
...
class ExperimentConfig:
    ...
    # 路径配置
    global DIR_PATH
    MODELS_PATH =  "/home/sunshixin/pycharm_workspace/experiment/models"  # 输入例子的路径
...
class MyTools:
    ...
    @staticmethod
    def print_check_mod_result(csv_file):
...
def plot_performance(
    ...
    for algo in algorithms:
        ...
        if repeated_run_time == 1:  # 如果每个实验只运行一次
...
def run_experiment():
    # 定义CSV文件的列名
    fieldnames = ['timestamp', 'formula', 'domain_size', 'algorithm', 'result', 'time_sec', 'memory_bytes', 'memory_kb', 'memory_mb', 'status', "dr_within_approx_confidence"]
    ...
    for group in ExperimentConfig.EXPERIMENT_GROUPS:
        ...
        with tqdm(total=total_iterations, desc="Overall Progress") as pbar:  # 创建一个总体进度条，显示实验整体进度
            ...
            for formula_name, file in models.items():
                ...
                # MyTools.print_check_mod_result(result_file_path)
                plot_performance(result_file_path, metric='time_sec', ylabel="Runtime (s)", output_suffix="time_comparison", repeated_run_time=1)
...
if __name__ == "__main__":
    ...
    ExperimentConfig.TIMEOUT_SECONDS = 10000
    ExperimentConfig.EXPERIMENT_GROUPS = [
        # {
        #     "name": "rmodk-regular-graphs",
        #     "domain_sizes": list(range(2, 5, 1)),
        #     # "domain_sizes": list(range(2, 3, 1)),
        #     "algorithms": ["dr"],
        #     "models": {
        #         # "0mod2-regular-graph": "0mod2-regular-graph-sc2.wfomcs",
        #         # "1mod2-regular-graph": "1mod2-regular-graph-sc2.wfomcs",
    ...
    run_experiment()
    # MyTools.print_check_mod_result("/home/sunshixin/pycharm_workspace/performance/check/results/regular-graphs/baseline_2-regular-graph.csv")
    # MyTools.print_check_mod_result("/home/sunshixin/pycharm_workspace/experiment2check/WFOMC/check/results_2025-07-29_09-53-04/regular-graphs/baseline_3-regular-graph_20250729_102637.csv")
    # MyTools.print_check_mod_result("/home/sunshixin/pycharm_workspace/experiment2check/WFOMC/check/results_2025-07-29_09-53-04/regular-graphs/baseline_4-regular-graph_20250729_110035.csv")
