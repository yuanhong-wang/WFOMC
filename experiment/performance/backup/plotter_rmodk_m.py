...
def plot_runtime_comparison(csv_file_name: str):
    ...
    """
    plot_performance(csv_file_name, 'time_sec', 'Runtime (s)', 'time_comparison')
...
def plot_memory_comparison(csv_file_name: str):
    ...
    """
    plot_performance(csv_file_name, 'memory_mb', 'Memory Usage (MB)', 'memory_comparison')
...
if __name__ == '__main__':
    ...
    RESULT_PATH = "/home/sunshixin/pycharm_workspace/WFOMC/experiment/performance/results/rmodk"
    # plot_runtime_comparison("BA_CC.csv")
    plot_runtime_comparison("rmodk_k.csv")
    #======================================================
